...
class AmbilAntrianPage extends StatefulWidget {
  ...
  final String kode; // Tambahkan parameter kode
...
class _AmbilAntrianPageState extends State<AmbilAntrianPage> with AppMixin{
  ...
  late String kode; // Simpan kode dalam state
  ...
  void initState() {
    ...
    kode = widget.kode; // Inisialisasi kode dengan nilai yang diterima dari konstruktor
            ...
            Visibility(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  await context.read<JanjiTemuProvider>().alter_status(_token, id);
                },
